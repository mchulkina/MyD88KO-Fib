...
# Group 2: colon 1 pellet
ps1.colon1.rarefied <- subset_samples(ps1.rarefied, Isolation.Source=="colon_1 palet")

# Group 3: Cecal content
...
# Group 2: colon 1 pellet
ps1.colon1.rarefied.ra <- transform_sample_counts(ps1.colon1.rarefied, function(ASV) ASV/sum(ASV) *100)
